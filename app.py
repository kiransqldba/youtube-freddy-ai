...
st.title("Freddy the YouTube AI Assistant")
...
if youtube_url:
    ...
    def hit_relevance_ai(transcript, prompt):
        ...
        with st.spinner(text="Freddy is thinking..."):
            url = "https://api-d7b62b.stack.tryrelevance.com/latest/studios/75fb8648-a402-41b5-992a-759717c95d12/trigger_limited"
            headers = {
            ...
            payload = {
                ...
                "project": "b2dbd0e04893-4495-ac81-cd8df21d072b"
            }
